function LoadHomePanel()
	...
	BG_HEADTEXT:SetText( "Panneau des utilités" )
	...
	HOME_STAFF.Paint = function( self, w, h )
		...
		draw.SimpleText( "Staff en ligne", "RP_SubFontThick", 24, 20, Color( 190, 190, 190 ) )
	...
	HOME_STATS.Paint = function( self, w, h )
		...
		draw.SimpleText( "Statistiques du serveur", "RP_SubFontThick", 24, 20, Color( 190, 190, 190 ) )
		...
		draw.SimpleText( "Joueurs", "RP_CatFont", 30, 83, Color( 255, 255, 255 ) )
		...
		draw.SimpleText( "Économie", "RP_CatFont", 30, 143, Color( 255, 255, 255 ) )
		...
		draw.SimpleText( "$"..tMoney.." En ce moment sur le serveur", "RP_SubFontThick", 92, 137, Color( 0, 0, 0 ) )
		draw.SimpleText( "$"..highMoney.." Joueur qui a le plus d'argent sur lui - "..string.upper(first.ply:Nick()), "RP_SubFontThick", 92, 154, Color( 190, 190, 190 ) )
		
		surface.SetDrawColor( Color( 211, 84, 0 ) )
		surface.SetMaterial( Material( "elitef4menu/ribbon.png" ) )
		surface.DrawTexturedRect( 24, 200, 60, 18 )
		
		draw.SimpleText( "Métiers", "RP_CatFont", 30, 203, Color( 255, 255, 255 ) )
		
		draw.SimpleText( table.Count( jobs ).." JOBS BEING USED", "RP_SubFontThick", 92, 197, Color( 0, 0, 0 ) )
		draw.SimpleText( "Le plus populaire - "..string.upper(team.GetName( table.GetWinningKey( teamTable ) )).." ("..team.NumPlayers(table.GetWinningKey( teamTable )).." PLAYERS)", "RP_SubFontThick", 92, 197 + 17, Color( 190, 190, 190 ) )
	...
	HOME_INFO.Paint = function( self, w, h )
		...
		draw.SimpleText( "Graphique des métiers utilisés", "RP_SubFontThick", 24, 20, Color( 190, 190, 190 ) )
