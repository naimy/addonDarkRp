...
table.insert( sideButtons, { Title = "Tableau", Func = function() LoadHomePanel() end } )
table.insert( sideButtons, { Title = "Commandes", Func = function() LoadCommandPanel() end } )
table.insert( sideButtons, { Title = "Métiers", Func = function() LoadCmdPanel() end } )
table.insert( sideButtons, { Title = "Armes", Func = function() OpenWeaponsTab() end } )
table.insert( sideButtons, { Title = "Entitées", Func = function() LoadEntitiesPanel() end } )
table.insert( sideButtons, { Title = "Munitions", Func = function() LoadAmmoPanel() end } )



table.insert( sideButtons, { Title = "Site", Func = function()
