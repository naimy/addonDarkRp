function OpenWeaponsTab()
	...
	WEP_WINDOW.Paint = function( self, w, h )
		...
		draw.SimpleText( "ARMES", "RP_SubFontThick", 24, 20, Color( 190, 190, 190 ) )
		
		surface.SetDrawColor( Color( 242, 242, 242 ) )
		surface.DrawLine( 24, 44, w - 26, 44 )
		
		if not weapons then
			draw.SimpleText( "RIEN !", "RP_SubFontThick", WEP_WINDOW:GetWide() / 2, WEP_WINDOW:GetTall() / 2, Color( 190, 190, 190 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		end
	end
	...
	SHIP_WINDOW.Paint = function( self, w, h )
		...
		draw.SimpleText( "CAISSES", "RP_SubFontThick", 24, 20, Color( 190, 190, 190 ) )
		
		surface.SetDrawColor( Color( 242, 242, 242 ) )
		surface.DrawLine( 24, 44, w - 26, 44 )
		
		if not shipments then
			draw.SimpleText( "RIEN !", "RP_SubFontThick", SHIP_WINDOW:GetWide() / 2, SHIP_WINDOW:GetTall() / 2, Color( 190, 190, 190 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
		end
	end
